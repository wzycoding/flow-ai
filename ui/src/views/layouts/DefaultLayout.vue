  ...
  <a-layout has-sider class="h-full">
    ...
    <a-layout-sider :width="240" class="min-h-screen bg-gray-50 p-2 shadow-none">
      <div class="bg-white h-full rounded-lg px-2 py-4 flex flex-col justify-between">
        ...
        <div class="">
          <!-- 顶部Logo -->
          <router-link to="/home" class="flex items-center gap-2 mb-5 px-2 py-1.5 rounded-lg hover:bg-gray-100 transition-all">
            <img src="@/assets/images/logo.png" alt="FlowAI" class="h-10 w-10 object-contain" />
            <span class="text-lg font-bold text-gray-800">FlowAI</span>
          </router-link>
          <!-- 创建AI应用按钮 -->
