...
from internal.schema.document_schema import CreateDocumentsReq, CreateDocumentsResp, UpdateDocumentEnabledReq, \
    UpdateDocumentNameReq, GetDocumentResp, GetDocumentsWithPageReq, GetDocumentWithPageResp
...
class DocumentHandler:
    ...
    def create_documents(self, dataset_id: UUID):
        ...
        documents, batch = self.document_service.create_documents(dataset_id, account=current_user, **req.data, )
    ...
    def get_documents_with_page(self, dataset_id: UUID):
        ...
        # 3.构建响应结构并映射
        resp = GetDocumentWithPageResp(many=True)
