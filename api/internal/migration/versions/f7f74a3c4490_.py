...
Revision ID: f7f74a3c4490
Revises: f6d2e49aa1ca
Create Date: 2026-06-23 23:47:44.702571
...
revision = 'f7f74a3c4490'
down_revision = 'f6d2e49aa1ca'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('tool_metadata', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'{}'::jsonb"), nullable=False),
    ...
    sa.Column('name', sa.String(length=255), server_default=sa.text("''::character varying"), nullable=False),
    sa.Column('description', sa.Text(), server_default=sa.text("''::text"), nullable=False),
    sa.Column('transport', sa.String(length=255), server_default=sa.text("'http'::character varying"), nullable=False),
    sa.Column('url', sa.String(length=1024), server_default=sa.text("''::character varying"), nullable=False),
    ...
    with op.batch_alter_table('mcp_tool_provider', schema=None) as batch_op:
        ...
        batch_op.create_index('mcp_tool_provider_name_idx', ['name'], unique=False)
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('mcp_tool_provider', schema=None) as batch_op:
        batch_op.drop_index('mcp_tool_provider_name_idx')
