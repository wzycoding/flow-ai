  ...
  <div class="flex gap-2 group">
    ...
    <div class="flex-1 flex flex-col items-start gap-2">
      ...
      <div
        ...
        :class="`${props.message_class} border border-gray-200 px-4 py-3 rounded-2xl break-all`"
      ...
      <div
        v-else
        :class="`${props.message_class} markdown-body border border-gray-200 px-4 py-3 rounded-2xl break-all`"
        style="color: #374151 !important;"
      ...
      <div v-if="props.suggested_questions.length > 0" class="flex flex-col gap-2">
        <div
          ...
          :key="idx"
          class="px-4 py-1.5 border rounded-lg cursor-pointer bg-white hover:bg-gray-50"
          style="color: #374151 !important;"
