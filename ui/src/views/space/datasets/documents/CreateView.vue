...
import { type Form, type FileItem, Message } from '@arco-design/web-vue'
...
const beforeUpload = (file: FileItem) => {
  if (file.file && file.file.size > MAX_FILE_SIZE) {
    Message.error(`文件 ${file.file.name} 超过10MB大小限制`)
    return false
  }
  return true
}
    ...
    <div class="min-h-[calc(100vh-160px)] p-[48px]">
      ...
      <div v-if="currentStep === 1" class="">
        ...
        <a-upload
          ...
          :limit="50"
          multiple
          tip="支持PDF、TXT、DOC、DOCX、MD，最多可上传50个文件，每个文件的大小不超过10MB"
            ...
            <a-form :model="createDocumentsForm.rule" ref="customRuleFormRef" layout="vertical">
              ...
              >
                <a-input-number
                  ...
                  :step="1"
                  :default-value="2000"
                  placeholder="请输入200-8000的数字，默认2000"
                />
              </a-form-item>
              <a-form-item
                field="chunk_overlap"
              ...
              >
                <a-input-number
                  ...
                  :step="1"
                  :default-value="500"
                  placeholder="请输入0-1000的数字，默认500"
                />
              </a-form-item>
